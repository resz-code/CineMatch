                                    ...
                                    {filtered.map((film) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-14 bg-[#262626] border border-zinc-800 rounded flex items-center justify-center text-[9px] text-zinc-600 font-medium select-none text-center leading-tight transition group-hover:text-zinc-500 shrink-0">
                                                    Poster
                                                </div>
                                                <div>
                                            ...
                                            <div className="text-right flex flex-col justify-between h-14 py-0.5 shrink-0">
                                                ...
                                                {!film.sudahRating ? (
                                                    ...
                                                    <Link to={`/film/${film.id}`} className="text-[11px] text-purple-400 hover:text-purple-300 hover:underline transition">
                                                        Lihat detail →
                                                    </Link>
                                                )}
                                            </div>
