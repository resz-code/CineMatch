            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-[#222222] rounded-xl border border-zinc-800 p-6 shadow-xl">
                    ...
                    <div className="flex border border-zinc-700 rounded-lg overflow-hidden mb-5">
                        ...
                        <Link to="/register" className="flex-1 py-2 text-sm font-medium text-center bg-[#222222] text-gray-400 hover:text-white transition">
                            Daftar
                        </Link>
                    </div>
                    ...
                    <form onSubmit={submit}>
                        ...
                        <div className="flex items-center justify-between mb-5">
                            ...
                            <Link to="/forgot-password" className="text-sm text-white hover:text-gray-300 hover:underline transition">
                                Lupa password?
                            </Link>
                        </div>
