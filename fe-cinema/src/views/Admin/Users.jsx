                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-zinc-300">
                            <thead className="bg-[#141414] border-b border-zinc-800">
                                <tr>
                                    <th className="text-left px-5 py-3 text-xs text-zinc-500 font-medium uppercase tracking-wider">No</th>
                                    <th className="text-left px-5 py-3 text-xs text-zinc-500 font-medium uppercase tracking-wider">Nama</th>
                                    <th className="text-left px-5 py-3 text-xs text-zinc-500 font-medium uppercase tracking-wider">Genre favorit</th>
                                    <th className="text-left px-5 py-3 text-xs text-zinc-500 font-medium uppercase tracking-wider">Film</th>
                                    <th className="text-left px-5 py-3 text-xs text-zinc-500 font-medium uppercase tracking-wider">Rating</th>
                                    <th className="text-left px-5 py-3 text-xs text-zinc-500 font-medium uppercase tracking-wider">Bergabung</th>
                                    <th className="text-left px-5 py-3 text-xs text-zinc-500 font-medium uppercase tracking-wider">Status</th>
                                    <th className="text-right px-5 py-3 text-xs text-zinc-500 font-medium uppercase tracking-wider">Aksi</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-zinc-800/50">
                                {filtered.map((user, index) => (
                                    <tr key={user.id} className="hover:bg-[#222222]/50 transition-colors">
