    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="max-w-6xl mx-auto px-6 py-8">
                ...
                {/* 1. PERUBAHAN: Warna bagian nama user (sandy) disesuaikan menggunakan ungu tombol navbar */}
                <div className="mb-6">
                    <h1 className="text-xl font-semibold text-white">
                        Halo, <span className="text-[#a855f7] font-medium">{auth.user.name}</span>! 👋
                    </h1>
                    ...
                    <div className="md:col-span-2 flex flex-col gap-6">
                        ...
                        <div className="bg-[#1a1a1a] border border-zinc-800 rounded-xl p-5">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <Link href="/jelajahi" className="text-xs text-purple-400 hover:underline transition">Lihat semua →</Link>
                            </div>
                            <div className="flex flex-col gap-3">
                                {rekomendasi.map((film) => (
                                    <div key={film.id} className="flex items-center gap-3 p-3 bg-[#222222] border border-zinc-800/50 rounded-xl group transition hover:border-zinc-700">
                                        <div className="w-10 h-14 bg-[#262626] rounded-lg border border-zinc-800 flex items-center justify-center flex-shrink-0 select-none">
                                        ...
                                        {/* 2. PERUBAHAN: Kapsul tetap Ungu Gelap, tapi warna tulisan persen diubah menjadi Putih (text-white) */}
                        ...
                        <div className="bg-[#1a1a1a] border border-zinc-800 rounded-xl p-5">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <Link href="/riwayat" className="text-xs text-purple-400 hover:underline transition">Lihat semua →</Link>
                            </div>
                            <div className="flex flex-col gap-3">
                                {riwayatTerakhir.map((film) => (
                                    <div key={film.id} className="flex items-center gap-3 p-3 bg-[#222222] border border-zinc-800/50 rounded-xl group transition hover:border-zinc-700">
                                        ...
                                        {/* Logika Bintang Rating atau Tombol */}
                                        {film.rating > 0 ? (
                    ...
                    <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-3.5">
                                {genreStats.map((g) => (
                                    <div key={g.genre}>
                                        ...
                                        <div className="w-full bg-[#262626] rounded-full h-1.5 border border-zinc-800/40">
                                            <div
                        ...
                        <div className="bg-[#1a1a1a] border border-zinc-800 rounded-xl p-5">
                            ...
                            <div className="flex flex-col gap-1">
                                <Link href="/jelajahi" className="flex items-center gap-2.5 text-xs text-zinc-400 hover:bg-[#222222] hover:text-white px-3 py-2 rounded-lg transition">
                                    <span className="text-sm">🎬</span> Jelajahi film
                                </Link>
                                <Link href="/riwayat" className="flex items-center gap-2.5 text-xs text-zinc-400 hover:bg-[#222222] hover:text-white px-3 py-2 rounded-lg transition">
                                    <span className="text-sm">📋</span> Riwayat tontonan
                                </Link>
                                <Link href="/profil" className="flex items-center gap-2.5 text-xs text-zinc-400 hover:bg-[#222222] hover:text-white px-3 py-2 rounded-lg transition">
