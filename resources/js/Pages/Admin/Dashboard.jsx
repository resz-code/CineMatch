    ...
    return (
        <AdminLayout>
            ...
            <div className="grid grid-cols-4 gap-4 mb-8">
                {stats.map((s) => (
                    <div key={s.label} className="bg-[#1a1a1a] border border-zinc-850 rounded-xl p-5 shadow-sm">
            ...
            <div className="bg-[#1a1a1a] border border-zinc-850 rounded-xl p-5 mb-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                {/* Film terbaru */}
                <div className="bg-[#1a1a1a] border border-zinc-850 rounded-xl p-5 shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="font-semibold text-xs text-zinc-400 uppercase tracking-wider">Film terbaru</h2>
                        <a href="/admin/film" className="text-xs text-purple-400 hover:text-purple-300 font-medium hover:underline transition">Lihat semua →</a>
                    </div>
                ...
                <div className="bg-[#1a1a1a] border border-zinc-850 rounded-xl p-5 shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <a href="/admin/users" className="text-xs text-purple-400 hover:text-purple-300 font-medium hover:underline transition">Lihat semua →</a>
                    </div>
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="border-b border-zinc-800">
